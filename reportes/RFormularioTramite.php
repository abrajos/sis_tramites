...
Class RFormularioTramite extends Report {
    ...
    function write($fileName) {
		...
		//if ($dataSource->getParameter('mostrar_costos') != 'no') {
            ...
            foreach ($dataSource->getDataSet() as $row) {
                ...
                if ($countList == 1 && $tipo_persona == "apoderado") {
                    $pdf->writeHTMLCell(180, 0, '', '', 'Yo: <b>'.$row['nombre_completo1'].'</b> (Apoderado)  con C.I. N°: <b>'.$row['ci'].'</b> expedicion <b>'.$row['expedicion'].'</b>', 0, 1, 0, true, 'J', true);
                    /*
                    $pdf->Cell($w = 180, $h = $hMedium, $txt = $row['nombre_completo1'], $border = 0, $ln = 0, $align = 'L', $fill = false, $link = '', $stretch = 0, $ignore_min_height = false, $calign = 'T', $valign = 'L');	
                    $pdf->SetFont('', 'N');
                    ...
                    $pdf->Cell($w = 7, $h = $hMedium, $txt = 'expedicion', $border = 0, $ln = 0, $align = 'L', $fill = false, $link = '', $stretch = 0, $ignore_min_height = false, $calign = 'T', $valign = 'M');	   	
                    ...
                    */
                    ...
                    $pdf->writeHTMLCell(180, 0, '', '', 'Yo: <b>'.$row['nombre_completo1'].'</b>  con C.I. N°: <b>'.$row['ci'].'</b> expedicion <b>'.$row['expedicion'].'</b>', 0, 1, 0, true, 'J', true);
                    /*
            ...
            $pdf->SetFont('', 'B');
            $pdf->Cell($w = 50, $h = $hMedium, $txt = strtoupper($dataSource->getParameter('nombre_tramite')), $border = 0, $ln = 0, $align = 'L', $fill = false, $link = '', $stretch = 0, $ignore_min_height = false, $calign = 'T', $valign = 'M');
            $pdf->Ln();
            $pdf->SetFont('', 'N');
            ...
            foreach ($dataSource->getDataSet() as $row) {
                ...
                if ( $tipo_persona == "propietario"){
                    $pdf->writeHTMLCell(180, 0, '', '', '<b>'.$row['nombre_completo1'].'</b> con C.I. N°: <b>'.$row['ci'].'</b> expedicion <b>'.$row['expedicion'].'</b>', 0, 1, 0, true, 'J', true);
                    /*
                    $pdf->SetFont('', 'B');
            ...
            $pdf->SetFont('', 'B');
            $pdf->Cell($w = 15, $h = $hMedium, $txt = $dataSource->getParameter('mes'), $border = 0, $ln = 0, $align = 'L', $fill = false, $link = '', $stretch = 0, $ignore_min_height = false, $calign = 'T', $valign = 'L');
            $pdf->SetFont('', 'N');
	        $pdf->Cell($w = 8, $h = $hMedium, $txt = '  de  ', $border = 0, $ln = 0, $align = 'L', $fill = false, $link = '', $stretch = 0, $ignore_min_height = false, $calign = 'T', $valign = 'M');	   
            $pdf->SetFont('', 'B');
        ...
        $pdf->Ln();
        $pdf->Cell($w = 180, $h = $hGlobal, $txt = 'Observación: '.$dataSource->getParameter('observacion'), $border = 0, $ln = 0, $align = 'L', $fill = false, $link = '', $stretch = 0, $ignore_min_height = false, $calign = 'T', $valign = 'M');
        $pdf->Ln(15);
        //$pdf->Cell($w = 46, $h = $hGlobal, $txt = 'al propietario.', $border = 0, $ln = 0, $align = 'L', $fill = false, $link = '', $stretch = 0, $ignore_min_height = false, $calign = 'T', $valign = 'M');
