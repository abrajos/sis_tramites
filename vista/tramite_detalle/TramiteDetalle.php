...
?>
<script>
Phx.vista.TramiteDetalle=Ext.extend(Phx.gridInterfaz,{

	constructor:function(config){
		this.maestro=config.maestro;
    	//llama al constructor de la clase padre
		Phx.vista.TramiteDetalle.superclass.constructor.call(this,config);
		this.init();
	...
	ActList:'../../sis_tramites/control/TramiteDetalle/listarTramiteDetalle',
	...
	preparaMenu: function (tb) {
        ...
        Phx.vista.TramiteDetalle.superclass.preparaMenu.call(this, tb)
    ...
    onButtonNew: function () {
        Phx.vista.TramiteDetalle.superclass.onButtonNew.call(this);
