...
Class RInformeLegal extends Report {
    ...
    function write($fileName) {
		...
		//if ($dataSource->getParameter('mostrar_costos') != 'no') {
            ...
            $pdf->Ln(7);
            $pdf->Cell($w = 90, $h = $hMedium, $txt = 'Registrado en Derechos Reales de: Quillacollo ', $border = 'LRTB', $ln = 0, $align = 'L', $fill = false, $link = '', $stretch = 0, $ignore_min_height = false, $calign = 'T', $valign = 'M');	   
          ...
          /*  if ( $dataSource->getParameter('id_tipo_tramite') == 3 || $dataSource->getParameter('id_tipo_tramite') == 4 ){
                ...
                $pdf->MultiCell(180, $h = $hMedium, 'Que, en virtud al Decreto Supremo N° 5056 de fecha 22 de noviembre de 2023; decreta en su Artículo Únicoque: A fin de efectivizar los mecanismos de resguardo de las áreas productivas para garantizar la seguridad alimentaria con soberanía, se modifica el párrafo I del Artículo 3 del Decreto Supremo N° 1809 de fecha 27 de noviembre de 2013 con el siguiente texto;', 0, 'J', 0, 0, '', '', true);
                $pdf->Ln(30);
                $pdf->SetFont('', 'B');
                $pdf->MultiCell(180, $h = $hMedium, 'I.- Las áreas productivas agropecuarias urbanas (A.P.A.U.) no podran ser cambio de uso y de suelo, ni urbanizables en un plazo de (15) años a partir de la publicación del presente Decreto Supremo".', 0, 'J', 0, 0, '', '', true);
                $pdf->Ln(30);
                $pdf->Ln();
            };  */
            $pdf->Ln(100);
